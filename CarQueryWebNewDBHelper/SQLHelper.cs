...
namespace CarQueryWebNew.DB
{
    ...
    public abstract class SqlHelper
    {
        ...
        public static readonly string ConnectionStringLocalTransaction =  ConfigurationManager.ConnectionStrings["SQLConnectionString"].ToString();
