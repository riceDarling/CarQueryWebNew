<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TotalQuery.aspx.cs" Inherits="Pages_SearchInfo_TotalQuery" %>
		...
		<div class="pagewrap" style="width:100%;height:100%;margin-top: 30px;">
			<div id="tjwqBtn" class="jczjcz left_list">
				...
				<div class="listbtnz  tjwqActive"><b></b>
					<div framehref>检测数据查询</div>
				</div>
				<div class="listbtnz"><b></b>
					<div framehref>车辆查询</div>
				</div>
				<div class="listbtnz"><b></b>
					<div framehref>检测站查询</div>
				</div>
			</div>
			<div id="tjwqMainframe">
				<div id="tjwqMainframe_bodybox">
					<div id="tjwqMainframe_body">
						<iframe name="mainFrame" id="mainFrame" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" src="./CheckDataQuery.aspx"></iframe>
					</div>
				</div>
			</div>
		</div>
